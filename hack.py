...
def totalCTABus():
    ...
    #res = 0
    #for itm in rts:
    #    res += routeNum('http://www.ctabustracker.com/bustime/api/v2/getvehicles?key=psRsTMdes3dddXDzSk5GcKNTy&rt={}'.format(itm))
    #return res
